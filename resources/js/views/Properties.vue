                    ...
                    <div class="col-lg-12">
                        <div class="section__breadcrumb-v1">
                            <ol class="breadcrumb mb-0 bg-light">
                                ...
                                <li class="breadcrumb-item"> <a href="#">Featured Properties</a></li>
                                ...
                                <div class="tabs__custom-v2 ">
                                    ...
                                    <div v-else class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade" id="pills-tab-one" role="tabpanel"
                                            ...
                                            <div class="row">
                                                <div v-for="property in featuredproperties" :key="property.id" class="col-lg-12">
                                        ...
                                        <div class="tab-pane fade show active" id="pills-tab-two" role="tabpanel"
                                            ...
                                            <div class="row">
                                                <div v-for="property in featuredproperties" :key="property.id" class="col-md-4 col-lg-4">
                                                    <div class="card__image card__box-v1">
