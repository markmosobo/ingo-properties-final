                ...
                <div class="col-12">
                  <div class="card top-selling overflow-auto">
                    ...
                    <div class="card-body pb-0">
                      <h5 class="card-title">All Blog Categories <span>| Today</span></h5>
                      <p class="card-text">
                   
                      <router-link to="/add-blogcategory" custom v-slot="{ href, navigate, isActive }">
                          <a
                            :href="href"
                      ...
                      <table id="AllBlogCategoriesTable" class="table table-borderless">
                        <thead>
                          <tr>
      ...
      methods: {
        ...
        deleteBlogCategory(id){
                Swal.fire({
                  ...
                  axios.delete('/api/blogcategory/'+id).then(() => {
                  toast.fire(
                    'Deleted!',
