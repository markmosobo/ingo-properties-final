<template>
    ...
    <section>
        <div class="profile__agency">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="row">
                            <div v-for="service in services" :key="service.id" class="col-lg-4">
                                <div class="cards mt-0">
                                    ...
                                    <div class="profile__agency-body">
                                        <div class="profile__agency-info">
                                            ...
                                            <p class="text-capitalize mb-1">{{service.description.substring(0,100)+"..."}}
                                            </p>
                                            
                                            <p @click="viewService(service.id)" class="mb-0 mt-3">
                                                <button class="btn btn-success btn-sm rounded-pill mr-1">
                                                    Read More
                                                    <i class="fa fa-angle-right ml-3 "></i>                                                </button>
        ...
        <!-- <section class="services__partner ">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-7">
                        <div class="title__head">
                            <h2 class="text-center text-capitalize">our other successful services</h2>
                            <p class="text-center text-capitalize">brand partners successful services trusted many clients
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="services__partner-logo">
...
export default {
  ...
  methods: {
    viewService(id){
        this.$router.push('/ourservices/'+id)
    },
    loadLists(){
