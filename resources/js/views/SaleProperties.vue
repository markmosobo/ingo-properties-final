                    ...
                    <div class="col-lg-12">
                        <div class="section__breadcrumb-v1">
                            <ol class="breadcrumb mb-0 bg-light">
                                ...
                                <li class="breadcrumb-item"> <a href="#">Properties for Sale</a></li>
                            ...
                            <div class="col-lg-12">
                                <div class="tabs__custom-v2 ">
                                    ...
                                    <ul class="nav nav-pills myTab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" style="color:brown;" data-toggle="pill" href="#pills-tab-one" role="tab"
                                                aria-controls="pills-tab-one" aria-selected="true">
                                                <span class="fa fa-th-list"></span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link active" style="color:brown;" data-toggle="pill" href="#pills-tab-two" role="tab"
                                    ...
                                    <div v-else class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade" id="pills-tab-one" role="tabpanel"
                                            ...
                                            <div class="row">
                                                <div v-for="property in saleproperties" :key="property.id" class="col-lg-12">
                                        ...
                                        <div class="tab-pane fade show active" id="pills-tab-two" role="tabpanel"
                                            ...
                                            <div class="row">
                                                <div v-for="property in saleproperties" :key="property.id" class="col-md-4 col-lg-4">
                                                    <div class="card__image card__box-v1">
