                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            ...
                            <img :src="getPhoto() + form.image_path" class="card-img-top" alt="No Image" />
                        </div>
                    </div> 
                    <div class="col-sm-6">
                      <label for="inputPassword" class="form-label">Change Photo</label>
                      <div class="col-sm-10">
    ...
    methods: {
       ...
       getData(){
        axios.get('/api/blog/'+this.$route.params.id, {
            ...
            // console.log("data", this.form.media.saved)
        })
       },
       loadLists() {
       ...
       submit(){
          axios.put("/api/blog/"+this.$route.params.id, this.form)
