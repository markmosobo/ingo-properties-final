                    ...
                    <div class="col-lg-12">
                        <div class="section__breadcrumb-v1">
                            <ol class="breadcrumb mb-0 bg-light">
                                ...
                                <li class="breadcrumb-item active"> <span class="text-capitalize"> {{project.name}}</span>
                                </li>
                ...
                <div class="row">
                    <div class="col-lg-8">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-lg-6">
                                        <a href="#" class="profile__agents-avatar">
                                            <img :src="getPhoto() + project.image_path" alt="" class="img-fluid ">
                                            <div v-if="project.featured == 1" class="total__property-agent">featured</div>
                                        </a>
                                    </div>
                                    <div class="col-md-6 col-lg-6 my-auto">
                                        <div class="profile__agents-info">
                                            ...
                                            <p v-if="project.status == 0" class="text-capitalize mb-1">ongoing</p>
                                            <p v-else class="text-capitalize mb-1">completed</p>

                                            <ul class="list-unstyled mt-2">
                                                <li><a href="#" class="text-capitalize"><span><i class="fa fa-building"></i>
                                                            location :</span> {{project.location}}</a>
                                                </li>
                        ...
                        <div class="single__detail-features tabs__custom">
                            <!-- <h5 class="text-capitalize detail-heading"> description</h5> -->
                                ...
                                <div class="tab-pane fade" id="pills-tab-four" role="tabpanel"
                                    ...
                                    <div class="single__detail-features-review ">
                                        <div class="media mt-4">
                                            <img src="images/profile-blog.jpg" alt="" class="img-fluid rounded-circle mr-3">
