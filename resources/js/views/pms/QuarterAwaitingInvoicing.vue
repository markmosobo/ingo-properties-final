                  ...
                  <div class="card top-selling overflow-auto">
                    ...
                    <div class="filter">
                      ...
                      <div class="card-body pb-0">
                        <h5 class="card-title">Awaiting Invoicing <span>| {{ statements.length }} awaiting invoicing in this quarter</span></h5>
                        <p class="card-text">
    ...
    export default {
      ...
      methods: {
        ...
        loadLists() {
             ...
             this.statements = response.data.lists.quarterawaitinginvoicing;
