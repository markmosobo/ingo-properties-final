                ...
                <div class="col-12">
                  <div class="card top-selling overflow-auto">
                    ...
                    <div class="card-body pb-0">
                      <h5 class="card-title">{{property.name}} Invoices <span>| Last Year ({{lastYear}})</span></h5>
                      <p class="card-text">
                         <div class="row">
    ...
    export default {
      ...
      methods: {
        ...
        getPropertyStatements() {
             ...
             //excludes vacants
             this.rentingstatements = response.data.pmslastyearpropertyrentingstatements;
          ...
          const receiptHTML = `
            ...
            <div class="watermark">${watermarkText}</div>
              <div class="receipt">
                ...
                <div class="receipt-info">
                  <p><strong>Invoice For:</strong>${this.lastYear}</p>
        ...
        generatePDF() {
            ...
            // Add title
            const titleText = (this.property.name + " " + this.lastYear + ' Rent Statement').toUpperCase();
            ...
            // Save the PDF
            let fileName = this.property.name + " " + this.lastYear + ' Rent Statement' + '_Total_Pages_' + currentPage + '.pdf';
            doc.save(fileName);
        },
