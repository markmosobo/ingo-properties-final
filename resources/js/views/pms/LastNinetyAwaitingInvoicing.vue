                  ...
                  <div class="card top-selling overflow-auto">
                    ...
                    <div class="filter">
                      ...
                      <div class="card-body pb-0">
                        <h5 class="card-title">Awaiting Invoicing <span>| {{ statements.length }} awaiting invoicing in the last 90 days</span></h5>
                        <p class="card-text">
...
<!--                               <div class="btn-group" role="group">
                                ...
                                <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                  ...
                                  <a @click="navigateTo('/pmsproperties')" class="dropdown-item" href="#">
    ...
    export default {
      ...
      methods: {
        ...
        loadLists() {
             ...
             this.statements = response.data.lists.lastninetyawaitinginvoicing;
