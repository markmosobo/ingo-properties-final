                ...
                <div class="col-12">
                  <div class="card top-selling overflow-auto">
                    ...
                    <div class="card-body pb-0">
                      <h5 class="card-title">Settled Invoices - {{property.name}} <span>| Last Year</span></h5>
                      <p class="card-text">
...
<!--                       <router-link to="/add-pmslandlord" custom v-slot="{ href, navigate, isActive }">
    ...
    export default {
      ...
      methods: {
        ...
        loadLists() {
             axios.get('/api/propertylastyearsettledinvoices/'+this.$route.params.id).then((response) => {
                //settled invoices
             this.statements = response.data.propertylastyearsettledinvoices;
             //all invoices (unsettled & vacants too)
             this.allstatements = response.data.propertylastyearmonthinvoices;
