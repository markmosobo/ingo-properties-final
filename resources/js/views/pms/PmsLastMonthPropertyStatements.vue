                ...
                <div class="col-12">
                  <div class="card top-selling overflow-auto">
                    ...
                    <div class="card-body pb-0">
                      <h5 class="card-title">{{property.name}} Statement <span>| Last Month</span></h5>
                      <p class="card-text">
    ...
    export default {
      ...
      methods: {
        ...
        getPropertyStatements() {
             axios.get('/api/pmslastmonthpropertystatements/'+this.$route.params.id).then((response) => {
        ...
        getPropertyExpenses()
        {
          axios.get('/api/pmslastmonthpropertyexpenses/'+this.$route.params.id).then((response) => {
            this.expenses = response.data.pmslastmonthpropertyexpenses;
        ...
        generatePDF() {
            ...
            // Subtract one month
            const createdAtDate = new Date(this.property.created_at);
            ...
            // Add title
            const titleText = (this.property.name+" "+newMonth+' '+newYear+' Rent Statement').toUpperCase();
            ...
            let fileName = this.property.name+" "+newMonth+' '+newYear+' Rent Statement' + '_Total_Pages_' + totalPages + '.pdf';
