<template>
    ...
    export default {
      ...
      methods: {
        ...
        getTenantStatements() {
             axios.get('/api/pmslastninetytenantstatements/'+this.$route.params.id).then((response) => {
             this.statements = response.data.pmslastninetytenantstatements;
        ...
        generatePDF() {
            ...
            // Add title
            const titleText = (tenantName+"'s "+' Last 90 Days Rent Statement').toUpperCase();
            ...
            // Save the PDF
            let fileName = tenantName +' '+' Last 90 Days Rent Statement' + '_Page_' + currentPage + '.pdf';
