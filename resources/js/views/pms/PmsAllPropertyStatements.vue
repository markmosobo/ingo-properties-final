                ...
                <div class="col-12">
                  <div class="card top-selling overflow-auto">
                    ...
                    <div class="card-body pb-0">
                      <h5 class="card-title">{{property.name}} Invoices <span>| All Time</span></h5>
                      <p class="card-text">
                         <div class="row">
    ...
    export default {
      ...
      methods: {
        ...
        getPropertyStatements() {
             axios.get('/api/pmsallpropertystatements/'+this.$route.params.id).then((response) => {
              //includes vacants
             this.statements = response.data.pmsallpropertystatements;
             //excludes vacants
             this.rentingstatements = response.data.pmsallpropertyrentingstatements;
        ...
        generatePDF() {
            ...
            // Add title
            const titleText = (this.property.name + " " + 'Full' + ' Rent Statement').toUpperCase();
            ...
            // Save the PDF
            let fileName = this.property.name + " " + 'Full' + ' Rent Statement' + '_Total_Pages_' + currentPage + '.pdf';
            doc.save(fileName);
        },
