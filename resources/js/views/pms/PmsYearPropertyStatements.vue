                ...
                <div class="col-12">
                  <div class="card top-selling overflow-auto">
                    ...
                    <div class="card-body pb-0">
                      <h5 class="card-title">{{property.name}} Statement <span>| This Year</span></h5>
                      <p class="card-text">
    ...
    export default {
      ...
      methods: {
        ...
        generatePDF() {
            ...
            // Add title
            const titleText = (this.property.name+" "+this.formatYear(new Date)+' Rent Statement').toUpperCase();
