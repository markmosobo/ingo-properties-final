                ...
                <div class="col-12">
                  <div class="card top-selling overflow-auto">
                    ...
                    <div class="card-body pb-0">
                      <h5 class="card-title">{{property.name}} Invoices <span>| This Year ({{currentYear}})</span></h5>
                      <p class="card-text">
                         <div class="row">
    ...
    export default {
      ...
      methods: {
        ...
        getPropertyStatements() {
             axios.get('/api/pmsyearpropertystatements/'+this.$route.params.id).then((response) => {
              //includes vacants
             this.statements = response.data.pmsyearpropertystatements;
             //excludes vacants
             this.rentingstatements = response.data.pmsyearpropertyrentingstatements;
