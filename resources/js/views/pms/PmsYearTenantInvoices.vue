                ...
                <div class="col-12">
                  <div class="card top-selling overflow-auto">
                    ...
                    <div class="card-body pb-0">
                      <h5 class="card-title">{{tenantName}}'s Invoices <span>| This Year ({{currentYear}})</span></h5>
                      <p class="card-text">
    ...
    export default {
      ...
      methods: {
        ...
        getTenantStatements() {
             ...
             this.statements = response.data.pmsyeartenantinvoices;
            ...
            <div class="watermark">${watermarkText}</div>
              <div class="receipt">
                ...
                <div class="receipt-info">
                  ...
                  <p><strong></strong> ${this.currentYear}</p>
        ...
        exportToExcel() {
          ...
          const filename = `${this.tenantName}_${this.currentYear}_INVOICES_${timestamp}.xlsx`;
        ...
        generatePDF() {
            ...
            // Add title
            const titleText = (this.tenantName + " " + this.currentYear + ' Rent Statement').toUpperCase();
            ...
            // Save the PDF
            let fileName = this.tenantName + " " + this.currentYear + ' Rent Statement' + '_Total_Pages_' + currentPage + '.pdf';
            doc.save(fileName);
        },
      //   generatePDF() {
      //       let pdfName = 'Full Statement';
