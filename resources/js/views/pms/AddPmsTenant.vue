    ...
    <TheMaster>
       ...
       <div class="card-body">
          ...
          <fieldset v-if="step == 1">
             ...
             <div class="col-lg-12 felx mt-4 row">
                ...
                <div class="col-sm-6 col-lg-6 text-end">
                    <button type="submit" @click.prevent="next()" class="btn btn-sm btn-primary rounded-pill">Next</button>
                </div>
            </div>
          </fieldset>
          ...
          <fieldset v-if="step == 2">
                  ...
                  <div class="row">
                    <div class="col-lg-12 col-md-4 label ">Rent & Deposit:<strong>KES {{depositRent}}</strong></div>
      ...
      buildReceiptContent() {
       ...
       getUnitInfo()
       {
            axios.get('/api/pmsunit/'+this.form.pms_unit_id).then((response) => {
             ...
             this.depositRent = this.unitinfo.deposit + this.unitinfo.monthly_rent;
