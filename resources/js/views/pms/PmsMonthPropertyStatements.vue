                ...
                <div class="col-12">
                  <div class="card top-selling overflow-auto">
                    ...
                    <div class="card-body pb-0">
                      <h5 class="card-title">{{property.name}} Statements <span>| This Month</span></h5>
                      <p class="card-text">
    ...
    export default {
      ...
      methods: {
        ...
        getPropertyStatements() {
             axios.get('/api/monthpmspropertystatements/'+this.$route.params.id).then((response) => {
             this.propertystatements = response.data.monthpmspropertystatements;
