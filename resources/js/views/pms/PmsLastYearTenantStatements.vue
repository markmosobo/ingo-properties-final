<template>
                ...
                <div class="col-12">
                  <div class="card top-selling overflow-auto">
                    ...
                    <div class="card-body pb-0">
                      <h5 class="card-title">{{tenant.first_name}} {{tenant.last_name}}'s Statement <span>| Last Year</span></h5>
                      <p class="card-text">
    ...
    export default {
      ...
      methods: {
        ...
        getTenantStatements() {
             axios.get('/api/pmslastyeartenantstatements/'+this.$route.params.id).then((response) => {
             this.statements = response.data.pmslastyeartenantstatements;
        ...
        generatePDF() {
            ...
            // Add title
            const titleText = (tenantName+"'s "+lastYear+' Rent Statement').toUpperCase();
            ...
            // Save the PDF
            let fileName = tenantName +"'s "+ lastYear+' Rent Statement' + '_Page_' + currentPage + '.pdf';
