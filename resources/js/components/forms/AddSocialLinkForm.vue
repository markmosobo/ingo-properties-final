<template>
    <div class="card px-2">
        ...
        <form class="row g-3">
            ...
            <input type="text" v-model="form.name" class="form-control rounded-pill" id="inputNanme4">
            </div>
            <div class="col-12">
            <label for="inputNanme4" class="form-label">Link</label>
            <input type="text" v-model="form.link" class="form-control rounded-pill" id="inputNanme4">
            </div>
    ...
    export default {
       ...
       methods: {
          submit(){
             axios.post("api/sociallinks", this.form)
