...
Route::get('pmspropunits/{id}', [PmsUnitController::class, 'propUnits']);
Route::get('pmsunitstatements/{id}', [PmsUnitController::class, 'unitStatements']);
...
Route::get('monthpmspropertystatements/{id}', [PmsStatementController::class, 'monthPropertyStatements']);
Route::get('lastmonthpmspropertystatements/{id}', [PmsStatementController::class, 'lastMonthPropertyStatements']);
Route::get('lastninetypmspropertystatements/{id}', [PmsStatementController::class, 'lastNinetyPropertyStatements']);
Route::get('yearpmspropertystatements/{id}', [PmsStatementController::class, 'yearPropertyStatements']);
Route::get('quarterpmspropertystatements/{id}', [PmsStatementController::class, 'quarterPropertyStatements']);
Route::get('lastyearpmspropertystatements/{id}', [PmsStatementController::class, 'lastYearPropertyStatements']);
